...
/**
 * Unit tests related to the creation of VotingReceiptCollisionIncidents.
 */
public class VotingReceiptCollisionIncidentCreationUnitTest {
    ...
    /**
    * Verifies that an VotingReceiptCollisionIncident with two encrypted votes can be
