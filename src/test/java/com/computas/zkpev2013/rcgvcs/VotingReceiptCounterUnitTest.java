...
public class VotingReceiptCounterUnitTest {
     ...
     */
    @Test
    public void mustReturnAnEmptyListOfEncryptedVotesByDefault() {
        assertTrue(counter.getEncryptedVotes().isEmpty());
    }
    ...
    /**
     * Verifies that the constructor sets the voting receipt correctly.
     */
    @Test
    public void constructorMustSetTheVotingReceipt() {
        assertEquals(counter.getVotingReceipt(),
            new VotingReceipt(SAMPLE_VOTING_RECEIPT_LINE));
    }
}
