...
public class DecryptionLineWithIncorrectProofIncidentUnitTest {
    ...
    private static final String SAMPLE_ENC_VOTE_OPTS_STRING = "(,)";
    private static final String SAMPLE_DEC_VOTE_OPTS_STRING = "(3741264158469368466404212269249748092711943731820583364814408291710732477410869254686238207275582240120832,3741264158469368466404212269249748092711943731820583364814408291710732477410869254686238207275582240120832)";
