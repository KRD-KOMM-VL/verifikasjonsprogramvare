...
/**
 * Unit tests on EncryptedVotesHashMap.
 */
public class EncryptedVotesHashMapUnitTest {
    ...
    /**
     * Creates a EncryptedVotesHashMap for the tests.
     */
    ...
    public void mustCreateAnIncidentWhenTryingToAddABrokenLine() {
        map.addEncryptedVoteOrAddIncident(BROKEN_LINE, results);
        assertTrue(results.contains(
                new EncryptedVoteBrokenLineIncident(BROKEN_LINE)));
    }
     ...
     */
    @Test
    public void mustNotCreateAnIncidentWhenTryingToAddAnEncryptedVoteWithADifferentEncVoteOptIdsValue() {
        map.addEncryptedVoteOrAddIncident(GIVEN_SAMPLE_LINE, results);
        map.addEncryptedVoteOrAddIncident(SAMPLE_LINE_WITH_OTHER_ENC_VOTING_OPT_IDS,
            results);
        assertTrue(results.isEmpty());
    }
     ...
     */
    @Test
    public void mustNotCreateAnIncidentWhenTryingToAddAnEncryptedVoteWithADifferentContestId() {
        map.addEncryptedVoteOrAddIncident(GIVEN_SAMPLE_LINE, results);
        map.addEncryptedVoteOrAddIncident(SAMPLE_LINE_WITH_OTHER_CONTEST_ID,
            results);
     ...
     */
    @Test
    public void mustNotCreateAnIncidentWhenTryingToAddAnEncryptedVoteWithADifferentElectionId() {
        map.addEncryptedVoteOrAddIncident(GIVEN_SAMPLE_LINE, results);
        map.addEncryptedVoteOrAddIncident(SAMPLE_LINE_WITH_OTHER_ELECTION_ID,
            results);
     ...
     */
    @Test
    public void mustNotCreateAnIncidentWhenTryingToAddAnEncryptedVoteWithADifferentElectionEventId() {
        map.addEncryptedVoteOrAddIncident(GIVEN_SAMPLE_LINE, results);
        map.addEncryptedVoteOrAddIncident(SAMPLE_LINE_WITH_OTHER_ELECTION_EVENT_ID,
            results);
