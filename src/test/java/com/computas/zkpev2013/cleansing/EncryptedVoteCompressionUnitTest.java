...
public class EncryptedVoteCompressionUnitTest {
    private static final int COMPRESSION_FACTOR = 15;
    private static final BigInteger AREA_PRIME = new BigInteger("4057");
    ...
    private static final List<BigInteger> MESSAGE_COMPONENT_OF_COMPRESSED_ENC_OPT_IDS =
        Arrays.asList(new BigInteger(
                ""));
