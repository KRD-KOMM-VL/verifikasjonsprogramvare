...
public class NizkpCleansingFunctionalTest {
    ...
    public void createVcsEncryptedVoteRetainedMoreThanOnce() {
        ecryptedVoteRetainedMoreThanOnce = new EncryptedVote(ENCRYPTED_VOTE_RETAINED_MORE_THAN_ONCE_LINE);
    }
     ...
     */
    @Test
    public void resultsMustContainEncryptedVoteBrokenLineIncident() {
     ...
     */
    @Test(enabled = false)
    public void resultsMustContainEncryptedVoteRetainedMoreThanOnceIncidentForTheCleansedVoteLineRetainedTwice() {
        assertZkpContainsIncident(nizkp,
            new EncryptedVoteRetainedTooOftenIncident(
                ecryptedVoteRetainedMoreThanOnce, 1, 2));
    }
     ...
     */
    @Test(enabled = false)
    public void resultsMustContainInjectedCleansedVoteLineIncident() {
        assertZkpContainsIncident(nizkp,
