...
public class NizkpCleansingFunctionalTest {
    ...
    private static final String ELECTION_EML_FILE_NAME = "NizkpCleansing2013FunctionalElectionDefinition.eml";
    ...
    public void createVcsEncryptedVoteRetainedMoreThanOnce() {
        vcsEncryptedVoteRetainedMoreThanOnce = new EncryptedVote(ENCRYPTED_VOTE_RETAINED_MORE_THAN_ONCE_LINE);
    }
