...
public class EncryptedVoteRetentionCounterUnitTest {
    ...
    /**
     * Verifies that by default, the number of expected matches is 1.
     */
    @Test
    public void expectedNoOfMatchesIsOneByDefault() {
        assertEquals(counter.getExpectedNoOfMatches(), 1);
    }

    /**
     * Verifies that after adding another encrypted vote, the number of expected matches is 2.
     */
    @Test
    public void expectedNoOfMatchesIsTwoAfterAddingAnotherEncryptedVote() {
        counter.registerEncryptedVote(encryptedVote);
        assertEquals(counter.getExpectedNoOfMatches(), 2);
    }

    /**
     * Verifies that by default, the number of actual matches is 0.
     */
    @Test
    public void actualNoOfMatchesIsZeroByDefault() {
        assertEquals(counter.getActualNoOfMatches(), 0);
    }
     ...
     */
    @Test
    public void actualNoOfMatchesIsOneAfterRegisteringACleansedVoteAsAMatch() {
        counter.registerMatch(cleansedVote);
        assertEquals(counter.getActualNoOfMatches(), 1);
    }

    /**
     * Verifies that after registering a cleansed vote as a match a second time, the number of
     * actual matches is 2.
     */
    @Test
    public void actualNoOfMatchesIsTwoAfterRegisteringACleansedVoteAsAMatchTwice() {
        counter.registerMatch(cleansedVote);
        counter.registerMatch(cleansedVote);
        assertEquals(counter.getActualNoOfMatches(), 2);
    }
}
