...
public class EncryptedVoteRetentionCounterUnitTest {
    ...
    /**
     * Verifies that the counter detects a match if the prime of the area
     ...
     */
    @Test(enabled = false)
    public void mustMatchIfThresholdAreaPrimeIsCorrectPrime() {
        AreasMap areas = new AreasHashMap();
    ...
    /**
     * Verifies that the counter detects a match if the prime of the threshold area
     * of the threshold area of the encrypted vote is set to be the correct prime.
     *
     * TODO
     */
    @Test(enabled = false)
    public void mustMatchIfSecondThresholdAreaPrimeIsCorrectPrime() {
        AreasMap areas = new AreasHashMap();
        areas.add(new Area(NON_MATCH_GENERATING_AREA_WITH_THRESHOLD_AREA_LINE));
    ...
    /**
     * Verifies that the counter detects a match if the prime of the area 100
     * of the encrypted vote is set to be the correct prime.
     *
     * TODO
     */
    @Test(enabled = false)
    public void mustMatchIfArea100PrimeIsCorrectPrime() {
        AreasMap areas = new AreasHashMap();
     ...
     */
    @Test(enabled = false)
    public void mustMatchIfThresholdAreaOfArea100PrimeIsCorrectPrime() {
        AreasMap areas = new AreasHashMap();
        areas.add(new Area(NON_MATCH_GENERATING_AREA_WITH_AREA_100_LINE));
        areas.add(new Area(
