...
public class CleansedVoteUnitTest {
    ...
    private static final List<BigInteger> GIVEN_ENC_VOTE_OPT_IDS_MESSAGE_COMPONENTS =
        Arrays.asList(new BigInteger(
                ""));
    ...
    public void constructorMustSetTheMessageComponentOfTheEncryptedVoteOptionIdsCorrectly() {
        assertEquals(cleansedVote.getEncryptedVoteOptIds().getMessageComponents(),
            GIVEN_ENC_VOTE_OPT_IDS_MESSAGE_COMPONENTS);
    }
