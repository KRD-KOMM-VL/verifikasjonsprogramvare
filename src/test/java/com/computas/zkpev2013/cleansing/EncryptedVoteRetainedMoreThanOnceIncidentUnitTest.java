...
/**
 * Unit tests on EncryptedVoteRetainedMoreThanOnceIncident.
 */
public class EncryptedVoteRetainedMoreThanOnceIncidentUnitTest {
    ...
    private static final String SAMPLE_LINE_WITH_OTHER_UUID = OTHER_UUID +
        ...
        GIVEN_VOTER_ID + COMMA + CHANNEL_ID + COMMA + RECEIPT_VOTE_TIMESTAMP +
        COMMA + GIVEN_VOTE_Z_K_PROOF_SIG;
    private EncryptedVoteRetainedMoreThanOnceIncident incident;

    /**
    * Creates an incident to test against.
    */
    @BeforeMethod
    public void createEncryptedVoteRetainedMoreThanOnceIncident() {
        incident = new EncryptedVoteRetainedMoreThanOnceIncident(new EncryptedVote(
                    GIVEN_SAMPLE_LINE), 2);
    }
    ...
    /**
     * Verifies that the incident is equal to another incident with the same encrypted vote and number of matches.
     */
    @Test
    public void mustBeEqualToAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithTheSameEncryptedVoteAndNoOfMatches() {
        assertEquals(incident,
            new EncryptedVoteRetainedMoreThanOnceIncident(
                new EncryptedVote(GIVEN_SAMPLE_LINE), 2));
    }

    /**
     * Verifies that the incident has the same hashCode as another incident with the same encrypted vote and number of matches.
     */
    @Test
    public void mustHaveSameHashCodeAsAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithTheSameEncryptedVoteAndNoOfMatches() {
        assertEquals(incident.hashCode(),
            new EncryptedVoteRetainedMoreThanOnceIncident(
                new EncryptedVote(GIVEN_SAMPLE_LINE), 2).hashCode());
    }
     ...
     */
    @Test
    public void mustNotBeEqualToAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithAnotherEncryptedVote() {
        assertFalse(incident.equals(
                new EncryptedVoteRetainedMoreThanOnceIncident(
                    new EncryptedVote(SAMPLE_LINE_WITH_OTHER_UUID), 2)));
    }
     ...
     */
    @Test
    public void mustNotHaveSameHashCodeAsAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithAnotherEncryptedVote() {
        assertFalse(incident.hashCode() == new EncryptedVoteRetainedMoreThanOnceIncident(
                new EncryptedVote(SAMPLE_LINE_WITH_OTHER_UUID), 2).hashCode());
    }
     ...
     */
    @Test
    public void mustNotBeEqualToAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithAnotherNoOfMatches() {
        assertFalse(incident.equals(
                new EncryptedVoteRetainedMoreThanOnceIncident(
                    new EncryptedVote(GIVEN_SAMPLE_LINE), THREE)));
    }

    /**
     * Verifies that the incident doesn't have the same hashCode as another incident with another number of matches.
     */
    @Test
    public void mustNotHaveSameHashCodeAsAnotherEncryptedVoteRetainedMoreThanOnceIncidentWithAnotherNoOfMatches() {
        assertFalse(incident.hashCode() == new EncryptedVoteRetainedMoreThanOnceIncident(
                new EncryptedVote(GIVEN_SAMPLE_LINE), THREE).hashCode());
    }
    ...
    public void toStringMustBeCommaSeparatedline() {
        assertEquals(incident.toString(),
            "EncryptedVoteRetainedMoreThanOnceIncident," + GIVEN_UUID + ",2");
    }
}
