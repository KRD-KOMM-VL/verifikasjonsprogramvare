...
/**
 * Unit tests on MixingVerificationData.
 */
public class MixingVerificationDataUnitTest {
    ...
    /**
     * Creates a data object to run the unit tests against.
     * @throws ClassNotFoundException Should not be thrown.
     * @throws java.io.IOException  Should not be thrown.
     */
    @BeforeMethod
    public void createData() throws IOException, ClassNotFoundException {
        IzkpMixing izkp = new IzkpMixing(new String[] {
    ...
    */
    ...
    public void mustSetMixingUuidCorrectly() {
        assertEquals(data.getMixingUuid(), SAMPLE_MIXING_UUID);
    }
    ...
    public void mustSetInputVotesCorrectly() {
        assertEquals(data.getInputVotesString().getBytes(), SAMPLE_INPUT_VOTES);
    }
    ...
    public void mustSetOutputVotesCorrectly() {
        assertEquals(data.getOutputVotesString().getBytes(), SAMPLE_OUTPUT_VOTES);
    }
    ...
    public void mustSetAuditUuidCorrectly() {
        assertEquals(data.getAuditUuid(), SAMPLE_AUDIT_UUID);
    }
    ...
    public void mustSetInputVoteGroupsCorrectly() {
        assertVoteGroupIsThreeZeroes(data.getInputVoteGroups());
    }
    ...
    */
    ...
    public void mustSetOutputVoteGroupsCorrectly() {
        assertVoteGroupIsThreeZeroes(data.getOutputVoteGroups());
    }
    ...
    public void mustSetNumberOfReencryptionProofsCorrectly() {
        assertEquals(data.getReencryptionProofs().size(), 1);
    }
    ...
    public void mustSetEOfFirstReencryptionProofCorrectly() {
        assertEquals(data.getReencryptionProofs().get(0).getE(),
    ...
    public void mustSetSOfFirstReencryptionProofCorrectly() {
        assertEquals(data.getReencryptionProofs().get(0).getS(),
            SAMPLE_REENCRYPTION_PROOF_S);
    }
    ...
    public void mustCalculateInputVoteGroupsFactorsCorrectly() {
        data.computeInputVoteGroupsFactors(SAMPLE_P);
        assertEquals(data.getInputVoteGroupsFactors().get(0),
    ...
    public void mustCalculateOutputVoteGroupsFactorsCorrectly() {
        data.computeOutputVoteGroupsFactors(SAMPLE_P);
        assertEquals(data.getOutputVoteGroupsFactors().get(0),
    ...
    public void mustCalculateNonInteractiveChallengeXCorrectly()
        ...
        assertEquals(data.calculateNonInteractiveChallengeX(SAMPLE_G, SAMPLE_H,
                SAMPLE_EL_GAMAL_INPUT_VOTE_GROUP_FACTORS,
                SAMPLE_EL_GAMAL_OUTPUT_VOTE_GROUP_FACTORS),
    ...
    public void mustCalculateGeneratorG1Correctly() {
        assertEquals(data.calculateGeneratorG1(SAMPLE_P, SAMPLE_G, SAMPLE_H,
    ...
    public void mustCalculatePublicKeyH1Correctly() {
        assertEquals(data.calculatePublicKeyH1(SAMPLE_P,
                SAMPLE_EL_GAMAL_INPUT_VOTE_GROUP_FACTORS,
                SAMPLE_EL_GAMAL_OUTPUT_VOTE_GROUP_FACTORS,
    ...
    public void mustCalculateSchnorrMessageW1Correctly() {
        assertEquals(data.calculateSchnorrMessageW1(SAMPLE_P, GENERATOR_G1,
    ...
    public void mustCalculateSchnorrChallengeC1()
        throws NoSuchAlgorithmException {
        assertEquals(data.calculateSchnorrChallengeC1(SAMPLE_P, SAMPLE_G,
    ...
    public void mustVerifyCorrectProofAsCorrect()
        throws NoSuchAlgorithmException {
        assertTrue(data.verifyZeroKnowledgeProof(SAMPLE_P, SAMPLE_G, SAMPLE_H,
                SAMPLE_EL_GAMAL_INPUT_VOTE_GROUP_FACTORS,
