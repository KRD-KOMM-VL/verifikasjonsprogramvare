...
public class VcsEncryptedVoteUnitTest {
    ...
    private static final String GIVEN_SAMPLE_LINE = GIVEN_UUID + COMMA +
        ...
        GIVEN_VOTE_Z_K_PROOF_SIG + COMMA + GIVEN_VOTER_CERTIFICATE +
        ",200701.47.02.0000.000000.0001," + GIVEN_CONTEST_ID + COMMA +
        GIVEN_ELECTION_ID + COMMA + GIVEN_ELECTION_EVENT_ID + COMMA +
        GIVEN_VOTER_ID + ",CHANNEL_ID_UNCONTROLLED";
    private static final String GIVEN_VOTING_RECEIPT = "Y2FXd0N4aWVOQWd6enE5enNoMXFVc25BdVJJPQ==";
    private static final byte[] EXPECTED_SHA_1 = new byte[] {
            (byte) 218, 57, (byte) 163, (byte) 238, 94, 107, 75, 13, 50, 85,
            (byte) 191, (byte) 239, (byte) 149, 96, 24, (byte) 144, (byte) 175,
            (byte) 216, 7, 9
        };
    ...
    public void mustEncodeBase64() throws UnsupportedEncodingException {
        assertEquals(VcsEncryptedVote.encodeBase64(
    ...
    public void mustDigestCorrectly()
        ...
        byte[] actual = VcsEncryptedVote.hash("".getBytes(
                    VcsEncryptedVote.UTF_8));
        assertEquals(actual, EXPECTED_SHA_1);
    }
