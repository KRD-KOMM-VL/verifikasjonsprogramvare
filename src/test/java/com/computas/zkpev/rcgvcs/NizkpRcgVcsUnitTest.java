...
public class NizkpRcgVcsUnitTest {
    ...
    private static final String VCS_FILE_NAME = "Bar";
    ...
    public void createNizkp() {
        nizkp = new NizkpRcgVcs(new String[] {
                    RCG_FILE_NAME, VCS_FILE_NAME, RESULTS_FILE_NAME
                });
    }
     ...
     */
    @Test
    public void constructorSetsRcgFileName() {
        assertEquals(nizkp.getRcgFileName(), RCG_FILE_NAME);
    }
