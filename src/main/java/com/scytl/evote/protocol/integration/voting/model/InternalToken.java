...
/**
 * Interface for to represent token of the different identification services.
 */
public interface InternalToken extends Serializable, KeepMembers {
    String UTF_8 = "UTF-8";
    ...
    /**
     * Gets info about internal token
     * @return
     */
    String getInfo();

    /**
     * Gets Id of internal token
     * @return
     */
    String getId();
}
