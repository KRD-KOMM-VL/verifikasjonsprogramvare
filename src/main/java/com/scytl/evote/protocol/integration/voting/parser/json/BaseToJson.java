...
/**
 * Base class for converting objects to JSON. This is specifically used for
 * converting the data needed for the JS client. It is not meant as a general
 * purpose to JSON converter.
 */
