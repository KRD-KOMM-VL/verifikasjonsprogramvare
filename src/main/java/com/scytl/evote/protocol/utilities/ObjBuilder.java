 ...
 * written approval.
 */
package com.scytl.evote.protocol.utilities;


/**
 * Implements the build interface of the builder design pattern.
 */
public interface ObjBuilder<T> {
    /**
     * Builds the object <code>T</code>
     *
     * @return the object <code>T</code>
     */
    T build();
}
