...
/**
 * Class representing an incident about two encrypted votes mapping to the
 * same key in the encrypted vote. This would only happen in the ephemeric
 ...
 * a problem in the VCS, which results in the duplication of a encrypted
 * vote.
 *
 */
public class EncryptedVotesMapKeyCollisionIncident extends Incident {
    private final String uuid1;
    private final String uuid2;

    EncryptedVotesMapKeyCollisionIncident(String uuid1, String uuid2) {
        this.uuid1 = uuid1;
        this.uuid2 = uuid2;
    }
    ...
    public boolean equals(Object other) {
        ...
        privateEqual((EncryptedVotesMapKeyCollisionIncident) other);
    }
    ...
    private boolean privateEqual(EncryptedVotesMapKeyCollisionIncident other) {
