...
public class CleansedVote extends CsvLineParseable {
    ...
    protected void setAttributes(String[] attributes) throws Exception {
        byte[] encryptedVoteOptIdsAsByteArray = getAttributeAsMultilinedByteArray(attributes,
                VcsEncryptedVoteCsvIndex.ENC_VOTE_OPT_IDS);

        encryptedVoteOptIds = new ElGamalEncryptionPair(encryptedVoteOptIdsAsByteArray);
